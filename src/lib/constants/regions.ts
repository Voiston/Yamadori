...
export const BIOTOPE_REGIONS: BiotopeRegion[] = [
	// — Pays de la Loire —
	{
		...
		bbox: { south: 46.2, north: 47.55, west: -2.55, east: -1.05 },
		species: ['Pin maritime', 'Chêne vert', 'Tamaris']
	},
	{
		id: 'pdl-bocage',
		macroRegion: 'pays_de_la_loire',
		...
		species: ['Chêne pédonculé', 'Hêtre', 'Érable sycomore', 'If']
	},
	{
		id: 'pdl-foret-plaine',
		macroRegion: 'pays_de_la_loire',
		...
		species: ['Chêne sessile', 'Hêtre', 'Bouleau', 'Pin sylvestre']
	},
	{
		...
		species: ['Chêne vert', 'Saule', 'Aulne glutineux']
	},
	{
		id: 'pdl-frange-forez',
		macroRegion: 'pays_de_la_loire',
		...
		species: ['Pin sylvestre', 'Genévrier commun', 'Érable']
	},
	// — Pyrénées —
	{
		...
		species: ['Chêne pubescent', 'Hêtre', 'Noyer', 'Érable sycomore']
	},
	{
		...
		species: ['Pin noir', 'Pin sylvestre', 'Genévrier commun', 'Buis']
	},
	{
		...
		species: ['Pin à crochets', 'Mélèze', 'Rhododendron ferrugineux']
	},
	{
	...
	},
	{
		...
		species: ['Genévrier commun', 'Érable de Montpellier', 'Buis']
	}
];
