...
/**
 * Ireland basemap: OpenTopoMap + Esri World Imagery
 * (same honesty as PT/BE when no free national commercial-friendly topo is wired).
 */
...
export function createIeMapProvider(): CountryMapProvider {
	return {
		country: 'IE',
		plan: PLAN,
		ortho: ORTHO,
