...
/**
 * Portugal basemap: OpenTopoMap + Esri World Imagery
 * (same honesty as BE/CA when no free national commercial-friendly topo is wired).
 */
...
export function createPtMapProvider(): CountryMapProvider {
	return {
		country: 'PT',
		plan: PLAN,
		ortho: ORTHO,
